...
import EditableInput, { EditableInputProps } from '@/components/react-color-editable-input';
    ...
    return (
        ...
        >
            <EditableInput
                ...
                {...rProps}
                style={{ display: 'flex', flexDirection: 'row', ...rProps.style }}
            />
            <EditableInput
                label="綠色 (G): "
                value={rgba.g || 0}
            ...
            <EditableInput
                ...
                {...bProps}
                style={{ display: 'flex', flexDirection: 'row', ...bProps.style }}
            />
            {aProps && (
                <EditableInput
                    label="A"
